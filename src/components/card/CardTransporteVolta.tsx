...
export const CardTransporteVolta = ({
  meio = 'Carro',
  distancia = '---',
  tempoEstimado = '---',
  destino = 'destino',
  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Ionicons name={icone} size={14} color="#fff" style={styles.icon} />
        <Text style={styles.title}>{meio}</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.descricao}>
          Dist̢ncia: {distancia}
          {'\n'}Tempo estimado: {tempoEstimado} at̩ {destino}
          {precoUber ? `\nUber/Lyft: ${precoUber}` : ''}
        </Text>
      </View>
    </Animated.View>
...
export default CardTransporteVolta;
