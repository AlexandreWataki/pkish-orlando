ï»¿import { AtracaoParque } from '@/logic/types/atracao';
...
export const atracoesDisney: Partial<AtracaoParque>[] = [
  ...
  ...StarWars.atracoes.map((a) => ({ ...a, regiao: 'Star Wars: GalaxyÃ¢â‚¬â„¢s Edge', parque: StarWars.parque, atracaoSemFila: a.atracaoSemFila ?? false })),
  ...
  ...Pandora.atracoes.map((a) => ({ ...a, regiao: 'Pandora Ã¢â‚¬â€œ The World of Avatar', parque: Pandora.parque, atracaoSemFila: a.atracaoSemFila ?? false })),
];
