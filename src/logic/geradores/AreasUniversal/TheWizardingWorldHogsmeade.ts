export const TheWizardingWorldHogsmeade = {
  ...
  descricao: "Área temática de Hogsmeade, com simuladores, montanhas-russas e lojas que recriam o universo de *Harry Potter* com riqueza de detalhes.",
  ...
  atracoes: [
    {
      ...
      descricao: `Simulador 3D por Hogwarts com batalhas, criaturas mágicas e efeitos especiais, ficando mais imersivo ao sentar nas fileiras centrais.`,
      icone: "⚡",
    ...
    },
    {
      ...
      descricao: `Montanha-russa suave com vista panorâmica do Castelo de Hogwarts e percurso mais emocionante à noite.`,
      icone: "🦅",
    ...
    },
    {
      ...
      atracaoSemFila: false,
      turnoRecomendado: "tarde",
      descricao: `Passeio de trem com simulação imersiva ligando Hogsmeade ao Beco Diagonal, sendo melhor aproveitar fazendo o trajeto nos dois sentidos.`,
      icone: "🚂",
    ...
    },
    {
      ...
      atracaoSemFila: true,
      turnoRecomendado: "manha",
      descricao: `Loja onde ocorre a experiência da varinha escolher o bruxo, sendo mais envolvente em grupos menores.`,
      icone: "🪄",
    ...
    },
    {
      ...
      descricao: `Montanha-russa veloz pela Floresta Proibida em motos mágicas guiadas por Hagrid, sendo mais imersiva no assento da moto.`,
      icone: "🏍️",
