export const HowToTrainYourDragon = {
  ...
  descricao: "Área inspirada em *Como Treinar o Seu Dragão*, com montanhas-russas familiares, batalha de barcos e um show impressionante com fantoches e efeitos.",
  ...
  atracoes: [
    {
      ...
      descricao: "Coaster familiar com curvas suaves sobre Berk. Nos últimos vagões a sensação de velocidade aumenta.",
      icone: "🪽",
    ...
    },
    {
      ...
      descricao: "Gire e incline o seu dragão durante os treinos de corrida. Controle o ângulo para um pouco mais de emoção.",
      icone: "🐲",
    ...
    },
    {
      ...
      atracaoSemFila: false,
      turnoRecomendado: "tarde",
      descricao: "Treinamento de combate com canhões d’água. Você vai se molhar — leve capa ou troca de roupa.",
      icone: "💦",
    ...
    },
    {
      ...
      descricao: "Espetáculo com Hiccup e Banguela, fantoches gigantes e trilha épica. Chegue com antecedência para bons assentos.",
      icone: "🎭",
